...
def transform(vol, loc_shift, interp_method='linear', indexing='ij',phase_encoding='RL'):
    """
    ...
    # print('phase_encoding in transform is',phase_encoding)
    # if phase_encoding == 'RL':
    #     # y and z are constrained to zero
    #     # print('I am here')
    #     loc = [tf.cast(mesh[0], 'float32') + loc_shift[...,0],
    #             tf.cast(mesh[1], 'float32'),
    #             tf.cast(mesh[2], 'float32')]
    #
    # elif phase_encoding == 'AP':
    #     loc = [tf.cast(mesh[0], 'float32'),
    #             tf.cast(mesh[1], 'float32')+ loc_shift[...,1],
    #             tf.cast(mesh[2], 'float32')]
